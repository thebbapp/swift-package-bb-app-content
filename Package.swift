...
let package = Package(
    ...
    products: [.library(name: "BbAppContent", targets: ["BbAppContent"])],
    dependencies: [
        .package(
    ...
    targets: [
        .binaryTarget(
            name: "BbAppContent",
            url:
                "https://github.com/thebbapp/swift-package-bb-app-content/releases/download/v0.1.0/BbAppContent.xcframework.zip",
            checksum: "598189d0abac3e17eae31fd050620b05d79dffaa623a221ad855a218a36919a7"
        )
    ],
